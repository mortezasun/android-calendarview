...
fun JalaliCalendar.fromSolarHijriToLocalDate(): LocalDate {

    return fromSolarHijriToLocalDate(this.year, this.month, this.day)
}
...
fun fromSolarHijriToLocalDate(jy:Int, jm:Int, jd:Int): LocalDate {
