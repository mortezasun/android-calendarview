...
open class SolarHijriStatus(localInUse: Locale) : MonthStatus<SolarHijriDayStatus, DayStatus>(localInUse) {
    ...
    override fun getInstanceDay(): SolarHijriDayStatus {
    ...
    override fun setInstanceDay(monthInstance: SolarHijriDayStatus) {
        solarHijriDateRow = monthInstance
    }
    ...
    override fun atDay(day: Int): LocalDate {
        ...
        return JalaliCalendar(solarHijriDateRow.solarHijriDate.year, month, day).fromSolarHijriToLocalDate()
    }
